...
@Entity @Table(name="b2b_business_account") public class BusinessAccount extends BaseEntity {
    ...
    protected BusinessAccount(){} public BusinessAccount(String code,String name,String workshop,int plannedCapacity){this.code=code;this.name=name;this.workshop=workshop;this.plannedCapacity=plannedCapacity;}
